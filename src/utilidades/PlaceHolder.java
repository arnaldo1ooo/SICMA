...
/**
 * La clase PlaceHolder mostrará un aviso sobre un componente de texto cuando  
 * * El documento del campo de texto está vacío. La propiedad Mostrar se usa
 * para   * Determinar la visibilidad del aviso.
 *
 * La fuente y el color de primer plano de la solicitud se establecerán de forma
 * predeterminada en esas propiedades   * del componente de texto padre. Usted
 * es libre de cambiar las propiedades después de   * Clase de construcción.
 */
