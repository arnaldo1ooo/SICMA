 ...
 */
package forms.producto.clase_producto;
 ...
 */
public final class ABMClaseProducto extends javax.swing.JDialog {

    private ABMProductoViejo abmproducto; //Para que tenga relacion con su form padre

    public ABMClaseProducto(ABMProductoViejo abmproducto, java.awt.Frame parent, Boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jpTabla.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED), "Clase de producto", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Sitka Subheading", 1, 28), new java.awt.Color(0, 204, 204))); // NOI18N
        ...
        jpBotonesLayout.setVerticalGroup(
            ...
            .addGroup(jpBotonesLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnEliminar, javax.swing.GroupLayout.DEFAULT_SIZE, 55, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnReporte, javax.swing.GroupLayout.DEFAULT_SIZE, 55, Short.MAX_VALUE)
                .addContainerGap())
        );
            ...
            if (!txtDescripcion.getText().trim().isEmpty()) {
                ...
                if (JOptionPane.YES_OPTION == confirmado) {
                    ...
                    try {
                        ...
                        String sentencia = "CALL SP_ClaseProductoAlta ('" + descri + "')";
    ...
    public void RegistroModificar() {
        ...
        if (!cod.isEmpty() && !descri.isEmpty()) {
            ...
            if (JOptionPane.YES_OPTION == confirmado) {
                ...
                sentencia = "CALL SP_ClaseProductoModificar(" + cod + ",'" + descri + "')";
        ...
        try {
            ...
            if (filasel == -1) {
                ...
                if (confirmado == JOptionPane.YES_OPTION) {
                    ...
                    Connection con = Conexion.ConectarBasedeDatos();
                    String sentence;
                    sentence = "CALL SP_ClaseProductoEliminar(" + codigo + ")";
