 ...
 */
public class ABMProductoViejo extends javax.swing.JDialog {
    ...
    public ABMProductoViejo(java.awt.Frame parent, Boolean modal, JComboBox<metodos.MetodosCombo> cbProducto) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Principios Activos*:");
    ...
    private void TablaListaIsAsConsulta(String idproducto) {
        ...
        try {
            while (con.getResultSet().next()) {
                registro[0] = (con.getResultSet().getString("lia_ingredienteactivo"));
                registro[1] = (con.getResultSet().getString("ia_descripcion"));
    ...
    private void TablaDosisConsulta(String idproducto) {
        ...
        try {
            ...
            while (con.getResultSet().next()) {
                ...
                registro[1] = (df.format(Double.parseDouble(con.getResultSet().getString("do_dosismin"))) + " " + estado);
                registro[2] = (df.format(Double.parseDouble(con.getResultSet().getString("do_dosismax"))) + " " + estado);
                registro[3] = (con.getResultSet().getString("tc_descripcion"));
                registro[4] = (con.getResultSet().getString("do_tipocultivo"));
    ...
    public void RegistroModificar() {
        ...
        if (!txtNombreComercial.getText().trim().isEmpty() && !txtNRegistro.getText().trim().isEmpty()
            ...
            if (JOptionPane.YES_OPTION == confirmado) {
                ...
                try {
                    Connection con = conexion.Conexion.ConectarBasedeDatos();
