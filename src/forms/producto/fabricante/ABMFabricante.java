...
public final class ABMFabricante extends javax.swing.JDialog {
    ...
    public void TablaConsulta(String filtro) {//Realiza la consulta de los productos que tenemos en la base de datos
        String nombresp = "SP_FabricanteConsulta";
        String titlesJtabla[] = {"Codigo", "Descripción"};
        String titlesconsulta[] = {"fa_codigo", "fa_descripcion"};
    ...
    private void initComponents() {
        ...
        jpTabla.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED), "Fabricantes", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Sitka Subheading", 1, 28), new java.awt.Color(0, 204, 204))); // NOI18N
            ...
            .addGroup(jpTablaLayout.createSequentialGroup()
                ...
                .addGroup(jpTablaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jpTablaLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cbCampoBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE))))
        );
        ...
        jpBotonesLayout.setVerticalGroup(
            ...
            .addGroup(jpBotonesLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnModificar, javax.swing.GroupLayout.DEFAULT_SIZE, 56, Short.MAX_VALUE)
                .addGap(15, 15, 15)
        ...
        jpEdicionLayout.setHorizontalGroup(
            ...
            .addGroup(jpEdicionLayout.createSequentialGroup()
                ...
                .addGroup(jpEdicionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtDescripcion, javax.swing.GroupLayout.PREFERRED_SIZE, 583, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(jpPrincipalLayout.createSequentialGroup()
                        ...
                        .addGroup(jpPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jpPrincipalLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jpBotones, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jpPrincipalLayout.createSequentialGroup()
                        .addGap(309, 309, 309)
        ...
        jpPrincipalLayout.setVerticalGroup(
            ...
            .addGroup(jpPrincipalLayout.createSequentialGroup()
                ...
                .addGroup(jpPrincipalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jpPrincipalLayout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jpBotones, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jpPrincipal, javax.swing.GroupLayout.PREFERRED_SIZE, 912, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
            ...
            if (!txtDescripcion.getText().trim().isEmpty()) {
                ...
                if (JOptionPane.YES_OPTION == confirmado) {
                    ...
                    try {
                        ...
                        String sentencia = "CALL SP_FabricanteAlta ('" + descri + "')";
    ...
    public void RegistroModificar() {
        ...
        if (!cod.isEmpty() && !descri.isEmpty()) {
            ...
            if (JOptionPane.YES_OPTION == confirmado) {
                ...
                sentencia = "CALL SP_FabricanteModificar(" + cod + ",'" + descri + "')";
        ...
        try {
            ...
            if (filasel == -1) {
                ...
                if (confirmado == JOptionPane.YES_OPTION) {
                    ...
                    Connection con = Conexion.ConectarBasedeDatos();
                    String sentence;
                    sentence = "CALL SP_FabricanteEliminar(" + codigo + ")";
